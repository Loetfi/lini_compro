;(function($) {
    ...
    var wprtTheme = {
        ...
        googleMap: function() {
            if ( $().gmap3 ) {
                var uluru = {lat: -6.218055 , lng: 106.835048};
                var contentString = '<div id="content">'+
                '<div style="max-width: 300px;">'+
                '<h3>Epicentrum Walk South 529A</h3>'+
                '<p>Jl. HR. Rasuna Said, Kuningan, Jakarta</p>'+
                '<p>Telp : +62 21-5682703</p>'+
                '<p>Email : marketing@limaintisinergi.com marketinglini@gmail.com</p>'+ 
                '</div>';
                $('#gmap')
                .gmap3({
                    zoom: 14,
         ...
         googleMap2: function() {
            if ( $().gmap3 ) {
                var uluru = {lat: -6.226548, lng: 106.8456039};
                var contentString = '<div id="content">'+
                '<div style="max-width: 300px;">'+
                '<h3>Epicentrum Walk South 529A</h3>'+
                '<p>Jl. HR. Rasuna Said, Kuningan, Jakarta</p>'+
