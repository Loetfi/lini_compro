...
<div class="col-lg-9 col-md-9 col-sm-8 col-lg-push-3 col-md-push-3 col-sm-push-4 margin-bottom-80">
    ...
    <ul class="nav nav-tabs nav-top-border">
        ...
        <li><a href="#BalasanDisposisi" data-toggle="tab">Tanggapan ke Admin</a></li>
        <?php } ?>
    ...
    <div class="tab-content">
        ...
        <?php ## <!-- Disposisi TAB -->
        if ($detail['dispos'] != ''){ 
            $form_tindakan = 'Permohonan/page_disposisi.php';
            $this->load->view($form_tindakan);
        }
		?>
        <?php ## <!-- Balasan TAB -->
        if ($detail['status'] == 'Proses' || $detail['status'] == 'Selesai'){ 
            $form_tindakan = 'admin/Permohonan/page_03_balas.php';
            $this->load->view($form_tindakan);
        }
		?>
