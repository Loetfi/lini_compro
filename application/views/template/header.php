...
<head>
    ...
    <link rel="shortcut icon" href="assets/lini-logo.png">
            ...
            <div class="top-bar-inner-wrap">
                ...
                <div class="top-bar-content">
                    <span id="top-bar-text">
                        ...
                        <i class="fa fa-envelope"></i><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="741915061f11001d1a1334181d19151d1a001d071d1a1106131d5a171b19">[email&#160;protected]</a>
            ...
            <div class="wrap-inner">          
                <div id="site-logo" class="clearfix">
                    <div id="site-logo-inner">
                        <a href="home-slider-full-screen#" title="Construction" rel="home" class="main-logo">
                            <img src="assets/lini-logo.png" alt="Construction" data-retina="assets/img/logo-light@2x.png" width="70px">
                        </a>
                    </div>
                </div><!-- /#site-logo -->
                ...
                <nav id="main-nav" class="main-nav">
                    <ul class="menu">
                        <li class="menu-item menu-item-has-children current-menu-item"><a href="#">Home</a></li>
                        <li class="menu-item menu-item-has-children current-menu-item"><a href="#">Blog</a></li>
                        <li class="menu-item menu-item-has-children current-menu-item"><a href="#">Contact</a></li>
                    </ul>
                </nav><!-- /#main-nav -->
...
<div id="hero-section" data-number="3" data-image-1="slider1.jpg" data-image-3="slider2.jpg" data-image-2="assets/slider3.jpg" data-effect="fade">
    <div class="hero-content">
        <div class="hero-title scroll" data-min="28px" data-max="80px">
            <h1>Selamat Datang</h1>
            <h1>PT. Lima Inti Sinergi</h1>
        </div>

        <div class="hero-text">
            <p>Solid-Integrity-Inovative-Passionate.</p>
        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <h2 class="text-white text-center-mobile font-size-20 margin-bottom-0">Contractors & Construction Managers Since 2013</h2>
                                    <div class="wprt-spacer" data-desktop="0" data-mobi="20" data-smobi="20"></div>
                                </div><!-- /.col-md-8 -->

                                <div class="col-md-4">
                                    <div class="text-right text-center-mobile"><a href="#" class="wprt-button white rounded-3px">olid-Integrity-Inovative-Passionate.</a></div>
                                ...
                                <div class="col-md-4">
                                    <div class="wprt-icon-box accent-background rounded icon-effect-2 icon-left">
                                        ...
                                        <div class="content-wrap">
                                            <h3 class="dd-title font-size-18"><a href="#">Instalation and Maintenance</a></h3>
                                            <p>Layanan Jasa Instalasi, pemeliharaan dan perbaikan perangkat transmisi VSAT, Radio dan BTS</p>
                                        </div>
                                    </div>
                                                ...
                                                <div class="project-item">
                                                    <div class="inner">
                                                        ...
                                                        <figure class="effect-sadie">
                                                            ...
                                                            <figcaption>
                                                                <div>
                                                                    <h2><a target="_blank" href="page-project-detail#">LUXURY BUILDINGS</a></h2>
                                                                    <p>Construction</p>
                                                                </div>
                                                            </figcaption>           
                                                        </figure>
                                                ...
                                                <div class="project-item">
                                                    <div class="inner">
                                                        <figure class="effect-honey">
                                                            ...
                                                            <figcaption>
                                                                <div>
                                                                    <h2><a target="_blank" href="page-project-detail-2#">LUXURY BUILDINGS</a></h2>
                                                                    <p>Construction</p>
                                                                </div>
                                                            </figcaption>           
                                                        </figure>
                                                ...
                                                <div class="project-item">
                                                    <div class="inner">
                                                        <figure class="effect-oscar">
                                                            ...
                                                            <figcaption>
                                                                <div>
                                                                    <h2><a target="_blank" href="page-project-detail-3#">LUXURY BUILDINGS</a></h2>
                                                                    <p>Construction</p>
                                                                </div>
                                                            </figcaption>           
                                                        </figure>
                                                ...
                                                <div class="project-item">
                                                    <div class="inner">
                                                        <figure class="effect-zoe">
                                                            ...
                                                            <figcaption>
                                                                <div>
                                                                    <h2><a target="_blank" href="page-project-detail-4#">LUXURY BUILDINGS</a></h2>
                                                                    <p>Construction</p>
                                                                </div>
                                                            </figcaption>           
                                                        </figure>
            ...
            <div class="col-md-4">
                <div class="widget widget_text">
                    ...
                    <div class="textwidget">
                        <img src="assets/lini-logo.png" width="100" height="30" alt="image" class="margin-top-5 margin-bottom-25" />
                        <p>PT Lima Inti Sinergi adalah perusahaan yang bergerak dibidang layanan jasa Telekomunikasi dan Teknologi Informasi, 
                        Didirikan oleh team berpengalaman dalam pekerjaan jasa telekomunikasi pada tanggal 17 oktober 2013 
                        berdasarkan akta notaris Eka Astri Maerisa SH, MH, M.Kn No 12 dan disahkan Mentri Hukum dan Hak Azasi Manusia Republik Indonesia
                        melaluin Surat Keputusan No AHU-59774.AH.01.01 Tahun 2013 yang ditetapkan pada tanggal 19 November 2013.
                        </p>
...
<!-- Javascript -->
<script data-cfasync="false" src="/cdn-cgi/scripts/d07b1474/cloudflare-static/email-decode.min.js"></script><script type="text/javascript" src="assets/js/jquery.min.js"></script>
